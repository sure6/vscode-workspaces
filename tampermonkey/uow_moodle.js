...
function modifyWords(name = "hello world", speed = 3, animation_style = "animate__backInDown") {
    ...
    $h1Title.css({ "font-size": "50px", "text-align": "center", color: "red", "line-height": "120px", "font-weight": "bold" })
    // 自定义动画速度
    $("head").append(`
    <style>
    #motto {
...
(function () {
    ...
    if (isMoodle) {
        ...
        modifyWords("Time and tide wait for no man.", 3.5, animation_styles["tada"]);
    }
